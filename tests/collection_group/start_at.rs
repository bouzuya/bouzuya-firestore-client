// since v3.1
#[test]
fn test_collection_group_start_at() {
    fn _check<I>(
    ...
    {
        collection_group.start_at(values)
    }
}
...
#[tokio::test]
#[serial_test::serial]
async fn test_collection_group_start_at_get() -> anyhow::Result<()> {
    use bouzuya_firestore_client::Firestore;
    use bouzuya_firestore_client::FirestoreOptions;
    use std::collections::HashMap;
    let firestore = Firestore::new(FirestoreOptions::default())?;
    let sub_collection_name = format!("collection-group-start-at-{}", uuid::Uuid::now_v7());
    ...
    let query_snapshot = collection_group
        ...
        .get()
        .await?;
    assert_eq!(query_snapshot.size(), 4);
...
// since v3.1
#[tokio::test]
async fn test_collection_group_start_at_multiple_types() -> anyhow::Result<()> {
    use bouzuya_firestore_client::Firestore;
    use bouzuya_firestore_client::FirestoreOptions;
    ...
    let _query = collection_group.start_at(vec![Mixed::S("Alice".to_string()), Mixed::I(30)])?;
    Ok(())
}
