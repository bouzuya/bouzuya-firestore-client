// since v2.1
#[tokio::test]
async fn test_document_reference_impl_partial_eq() -> Result<(), bouzuya_firestore_client::Error> {
    ...
    let document_reference2 = firestore.doc("rooms/roomB")?;
    assert_ne!(document_reference, document_reference2);
    Ok(())
}
