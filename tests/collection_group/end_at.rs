// since v3.1
#[test]
fn test_collection_group_end_at() {
    fn _check<I>(
    ...
    {
        collection_group.end_at(values)
    }
}
...
#[tokio::test]
#[serial_test::serial]
async fn test_collection_group_end_at_get() -> anyhow::Result<()> {
    use bouzuya_firestore_client::Firestore;
    use bouzuya_firestore_client::FirestoreOptions;
    use std::collections::HashMap;
    let firestore = Firestore::new(FirestoreOptions::default())?;
    let sub_collection_name = format!("collection-group-end-at-{}", uuid::Uuid::now_v7());
...
// since v3.1
#[tokio::test]
async fn test_collection_group_end_at_multiple_types() -> anyhow::Result<()> {
    use bouzuya_firestore_client::Firestore;
    use bouzuya_firestore_client::FirestoreOptions;
    ...
    let _query = collection_group.end_at(vec![Mixed::S("Alice".to_string()), Mixed::I(30)])?;
    Ok(())
}
