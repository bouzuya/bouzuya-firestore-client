...
#[tokio::test]
#[serial_test::serial]
async fn test_query_end_at_get() -> anyhow::Result<()> {
    use bouzuya_firestore_client::Firestore;
    use bouzuya_firestore_client::FirestoreOptions;
    use std::collections::HashMap;
    let firestore = Firestore::new(FirestoreOptions::default())?;
    let collection_reference = firestore.collection("test-query-end-at")?;
...
// since v3.0
#[tokio::test]
async fn test_query_end_at_multiple_types() -> anyhow::Result<()> {
    use bouzuya_firestore_client::Firestore;
    use bouzuya_firestore_client::FirestoreOptions;
    ...
    let collection_reference = firestore.collection("rooms")?;
    let query = collection_reference.limit(1)?;
    let _query = query.end_at(vec![Mixed::S("Alice".to_string()), Mixed::I(30)])?;
    Ok(())
}
