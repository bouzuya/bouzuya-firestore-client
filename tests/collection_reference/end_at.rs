// since v3.0
#[test]
fn test_collection_reference_end_at() {
    fn _check<I>(
    ...
    {
        collection_reference.end_at(values)
    }
}
...
#[tokio::test]
#[serial_test::serial]
async fn test_collection_reference_end_at_get() -> anyhow::Result<()> {
    use bouzuya_firestore_client::Firestore;
    use bouzuya_firestore_client::FirestoreOptions;
    use std::collections::HashMap;
    let firestore = Firestore::new(FirestoreOptions::default())?;
    let collection_reference = firestore.collection("test-collection-reference-end-at")?;
...
// since v3.0
#[tokio::test]
async fn test_collection_reference_end_at_multiple_types() -> anyhow::Result<()> {
    use bouzuya_firestore_client::Firestore;
    use bouzuya_firestore_client::FirestoreOptions;
    ...
    let _query = collection_reference.end_at(vec![Mixed::S("Alice".to_string()), Mixed::I(30)])?;
    Ok(())
}
